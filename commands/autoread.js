...
async function autoreadCommand(sock, chatId, message) {
    try {
            ...
            await sock.sendMessage(chatId, {
                ...
                contextInfo: {
                    ...
                    forwardedNewsletterMessageInfo: {
                        ...
                        newsletterName: 'Adevos-X Tech Official',
                        serverMessageId: -1
                    }
                }
        ...
        const usageText = `• Current Mode: ${config.mode}
...
function isBotMentionedInMessage(message, botNumber) {
    ...
    if (textContent) {
        ...
        const botNames = [global.botname?.toLowerCase(), getBotName().toLowerCase(), 'bot', 'Adevos', 'Adevos-X Bot'];
